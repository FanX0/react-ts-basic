...
import RhfEasyLocal from '@/pages/requests/localstorage/crud/RhfEasyLocal';

describe('LocalStorage: RHF Easy', () => {
  beforeEach(() => {
    localStorage.clear();
  });

  it('supports create, edit/update, and delete via RHF', async () => {
